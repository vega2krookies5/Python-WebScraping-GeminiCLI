...
* @C:\webscraping_gemini\yes24\agent_scraping.md 해당 내용을 바탕으로 데이터를 수집하는 코드를 작성해 주세요.
...
* @C:\webscraping_gemini\yes24\agent_eda_yes24.md 문서의 내용에 따라 데이터 분석을 수행해 주세요.